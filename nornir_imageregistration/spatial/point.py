...
def PointBoundingBox(points):
    ...
    if(points.shape[1] == 2):
        return (min_point[iPoint.Y], min_point[iPoint.X], max_point[iPoint.Y], max_point[iPoint.X])
    elif(points.shape[1] == 3):
        return (min_point[iPoint3.Z], min_point[iPoint3.Y], min_point[iPoint3.X], max_point[iPoint3.Z], max_point[iPoint3.Y], max_point[iPoint3.X])
    else:
