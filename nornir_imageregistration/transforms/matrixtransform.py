...
class AffineMatrixTransform(base.ITransform, base.ITransformTranslation, DefaultTransformChangeEvents):
    ...
    def TranslateFixed(self, offset):
        ...
        self._post_transform_translation  = self._post_transform_translation + offset
    ...
    def TranslateWarped(self, offset):
        ...
        self._pre_transform_translation  = self._pre_transform_translation - offset
        self.OnTransformChanged()
        raise NotImplemented("This implementation is untested")
    ...
    def __getstate__(self):
        odict = {'_matrix': self._matrix,
                 ...
                 '_post_transform_translation': (self._post_transform_translation[0], self._post_transform_translation[1])}
        return odict
    ...
    def Load(TransformString: str, pixelSpacing: float = None):
        return nornir_imageregistration.transforms.factory.ParseFixedCenterOfRotationAffineTransform(TransformString, pixelSpacing)
...
class AffineMatrixTransform_GPU(base.ITransform, base.ITransformTranslation, DefaultTransformChangeEvents):
    ...
    @staticmethod
    def Load(TransformString: str, pixelSpacing: float = None, use_cp: bool=False):
