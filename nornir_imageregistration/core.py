...
def ReplaceImageExtramaWithNoise(image: np.ndarray, ImageMedian:float=None, ImageStdDev:float=None, size_cutoff:float=0.001):
    '''
    ...
    noised_image = nornir_imageregistration.RandomNoiseMask(image, mask, Copy=True)
    return noised_image
