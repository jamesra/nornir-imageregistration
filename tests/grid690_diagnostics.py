"""Non-blocking diagnostic artifacts for the Grid690 functional test."""
...
GRID690_TEST_CLASS = "TestRefineGrid690Functional"
...
def plot_mosaic_grid_target_points(
    ...
    title = "Grid690 target control points (L4)"
...
def _assemble_mosaic_l4(
    ...
    """Assemble a mosaic at the Grid690 registration downsample for diagnostics."""
...
def write_grid690_diagnostics(
        ...
        *,
        ...
        test_class: str = GRID690_TEST_CLASS,
    ...
    assembled_path = os.path.join(output_dir, "grid690_assembled_L4.png")
    mask_path = os.path.join(output_dir, "grid690_assembled_mask_L4.png")
    grid_points_path = os.path.join(output_dir, "grid690_target_grid_points.png")
    worst_diff_path = os.path.join(output_dir, "grid690_seam_worst_diff.png")
    report_path = os.path.join(output_dir, "grid690_seam_report.json")
...
def write_grid690_comparison_diagnostics(
    ...
    artifact_paths = write_grid690_diagnostics(
        refined_mosaic,
        tile_dir,
        score_mosaic_on_translated_overlaps(
            refined_mosaic,
    ...
    translated_assembled_path = os.path.join(output_dir, "grid690_translated_assembled_L4.png")
    translated_mask_path = os.path.join(output_dir, "grid690_translated_assembled_mask_L4.png")
    translated_worst_diff_path = os.path.join(output_dir, "grid690_translated_seam_worst_diff.png")
    report_path = artifact_paths.get("report", os.path.join(output_dir, "grid690_seam_report.json"))
