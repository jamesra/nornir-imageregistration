...
class Test(unittest.TestCase):
    ...
    def testShowGrayscaleFailButton(self): 
        self.assertFalse(nornir_imageregistration.ShowGrayscale(self.imageA, title="Ensure the FAIL button works by clicking it now\nSelect Pass button for all other tests", PassFail=True))
    ...
    def testShowGrayscale_single_image(self):
        ...
        self.assertTrue(nornir_imageregistration.ShowGrayscale(self.imageA,
                                                               ...
                                                               image_titles='A',
                                                               rois=nornir_imageregistration.Rectangle.CreateFromBounds((1.5, 1.5, self.imageA.shape[0]- 1.5, self.imageA.shape[1] - 1.5 )),
                                                               PassFail=True))
    ...
    def testShowGrayscale_basics(self):
        ...
        self.assertTrue(nornir_imageregistration.ShowGrayscale(self.grid_2x3, title="2x3 images in a grid with a title", PassFail=True))
    ...
    def testShowGrayscale_autolayout(self):
        ...
        self.assertTrue(
            nornir_imageregistration.ShowGrayscale(self.list_6x1, title="Six images with reasonable auto-layout and image titles", image_titles=self.list_6x1_titles, PassFail=True))
        self.assertTrue(
            nornir_imageregistration.ShowGrayscale(self.list_6x1,
                                                   ...
                                                   image_titles=self.list_6x1_titles, rois=self.list_6x1_roi, PassFail=True))
